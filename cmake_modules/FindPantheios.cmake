...
IF(PANTHEIOS_INCLUDE_DIR)
    ...
    FIND_LIBRARY(PANTHEIOS_CORE_LIBRARY     NAMES pantheios.1.core.gcc45.mt.debug        PATHS ${PANTHEIOS_LIBRARY_SEARCH_DIR})
    FIND_LIBRARY(PANTHEIOS_UTIL_LIBRARY     NAMES pantheios.1.util.gcc45.mt.debug        PATHS ${PANTHEIOS_LIBRARY_SEARCH_DIR})
    FIND_LIBRARY(PANTHEIOS_FE_LIBRARY       NAMES pantheios.1.fe.all.gcc45.mt.debug      PATHS ${PANTHEIOS_LIBRARY_SEARCH_DIR})
    FIND_LIBRARY(PANTHEIOS_BE_FILE_LIBRARY  NAMES pantheios.1.be.fprintf.gcc45.mt.debug  PATHS ${PANTHEIOS_LIBRARY_SEARCH_DIR})
    FIND_LIBRARY(PANTHEIOS_BEC_FILE_LIBRARY NAMES pantheios.1.bec.fprintf.gcc45.mt.debug PATHS ${PANTHEIOS_LIBRARY_SEARCH_DIR})
