...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
void uSE_Quaternion::set_real( const float inReal )
{
    m_real = inReal;
}
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
void uSE_Quaternion::getNormSquared( float& outNorm )
{
    float tmp;
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
uSE_GLVector uSE_Quaternion::to_axis()
{
    float angle = acos(m_real) * 2;
    uSE_GLVector tmp = m_vector;
    tmp.normalize();
    std::cout<<"angle : "<<angle<<" vec x y z : "<<tmp.getX()<<" "<<tmp.getY()<<" "<<tmp.getZ()<<std::endl;
    return tmp;
}
